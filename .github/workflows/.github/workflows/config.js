 ...
 *
 *     node scripts/detect-ats.mjs
 *
 * which probes each careers URL, writes `scrape_method` and `ats_slug` back to
 * Supabase, and prints the ones it could not resolve.
 *
 * run.js should skip any company where method is null, and log it as skipped
 * rather than failed.
 */
